"""
╔══════════════════════════════════════════════════════════════════╗
║            GEM HUNTER BOT — Standalone v3.3 "Clean Sniper"      ║
║                                                                  ║
...
def format_summary(scanned: int, skipped: int, found: int, sent: int,
    ...
    if halted:
        return f"🛑 <b>GEM HUNTER v3.3 — HALT</b>\nBTC crash. Scan dilewati.\n<i>{now}</i>"
    return (
        f"💎 <b>GEM HUNTER v3.3 Clean Sniper Scan Selesai</b>\n━━━━━━━━━━━━━━━━━━━━\n"
...
def run_scan() -> None:
    log("=" * 55)
    log(f"💎 GEM HUNTER v3.3 Clean Sniper — {datetime.now(WIB).strftime('%Y-%m-%d %H:%M WIB')}")
    log("=" * 55)
